...
### Workflow
Follow these steps to get minA2 to work with your program:
...
3. If running a twin experiment set the options in generate_data.py and then execute it to create data
